...
def get_list():
    ...
    data = '{"page":1,"rows":'+str(numOfPush)+',"orderBy":{"updateTime":"desc"},"affairName":null,"likeMap":{},"between":{},"in":{"bizStatus":["71"]}}'
    headers = {
...
def run(q, num, key,zhizheng_button):
    ...
    for each in ids:
        ...
        try:
            ...
            q.put(f"错误：{j}\n")
        print("\n")
    zhizheng_button.config(state=tk.NORMAL)
