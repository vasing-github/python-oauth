...
def get_list():
    ...
    data = '{"page":1,"rows":'+str(numOfPush)+',"orderBy":{"updateTime":"desc"},"affairName":null,"likeMap":{},"between":{},"in":{"bizStatus":["81"]}}'
...
def submitAffair(busiId,q):
    ...
    data = '{"affairId":"'+busiId+'","shardKey":"5119","handleType":9,"auditAdvice":1,"auditAdviceInfo":null}'
